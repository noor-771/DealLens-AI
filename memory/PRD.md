...
- **Better Alternatives** — 2-3 real market alternatives with brand, estimated price, and reason (generated by GPT-4o)
...
### 3c. Analytics & User Stats
- Event tracking: login_success, scan_started, scan_completed, scan_failed, text_scan_*, language_changed, history_viewed, profile_viewed, logout
- Backend endpoints: `POST /api/analytics/event`, `GET /api/analytics/stats`
- Profile screen shows: Total Scans, Avg Deal Score, Best Deal, Top Category (real data from MongoDB aggregation)
